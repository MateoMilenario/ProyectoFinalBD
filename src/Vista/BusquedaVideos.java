 ...
 * @author Jose Gomez
 */
public class BusquedaVideos extends javax.swing.JFrame {

    Principal GUIprincipal5;
    FileOutputStream salida;

    LinkedList<Video> videosGuardados;
    LinkedList<Video> videosPalabraBuscar;
    LinkedList<Categoria> categoriasVideos;
    LinkedList<Video> videosCategoriasBuscar;
    LinkedList<ComentarioVideo> comentariosVideos;

    String nombreUsuarioBusquedadV;
    ...
    public BusquedaVideos(String NombreUsuarioBV) {
        ...
        videosCategoriasBuscar = new LinkedList<>();
        ...
        if (cambio) {
            ...
            MostrarVideos();
            traerComentarios(videosGuardados.get(contador).getIdContenidoV());
            ...
            jLabelContador.setText("/" + String.valueOf(videosGuardados.size()));
            BotonIzquierda.setEnabled(false);
            Contador.setText(String.valueOf(contadorVideo));
    ...
    private void initComponents() {
        ...
        FormatoV = new javax.swing.JTextField();
        ...
        jLabelVideo.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        jLabel6.setText("Formato Video");

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel7.setText("Nombre Video");
        ...
        DescripcionV.setEnabled(false);
        jScrollPane3.setViewportView(DescripcionV);

        CategoriaV.setEnabled(false);

        FormatoV.setEnabled(false);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(FormatoV, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel7)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(NombreV, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(CategoriaV, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
                    .addComponent(FormatoV, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel9)
                    .addComponent(CategoriaV, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        Descargar.setText("DESCARGAR VIDEO");
        ...
        mostrar.setText("Mostrar videos");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabelVideo, javax.swing.GroupLayout.PREFERRED_SIZE, 607, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(10, 10, 10)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabelVideo, javax.swing.GroupLayout.PREFERRED_SIZE, 405, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void AgregarComentarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarComentarioActionPerformed
        ...
        if (Pclave.equals("") && categoriaSeleccionada.equals("Categorias")) {
            ...
            PkImagen = videosGuardados.get(contador).getIdContenidoV();

        } else if (!"".equals(Pclave)) {

            PkImagen = videosPalabraBuscar.get(contador).getIdContenidoV();

        } else if (!"Categorias".equals(categoriaSeleccionada)) {

            PkImagen = videosCategoriasBuscar.get(contador).getIdContenidoV();
        ...
        if (descripcionComentario.equals("")) {
            ...
            ComentarioVideo CI = new ComentarioVideo(fechaPublicacionC, descripcionComentario);

            //*************************************************************************************
            boolean t = CcomentarioV.InsertarComentario(PkImagen, nombreUsuarioBusquedadV, CI);
    ...
    private void BotonDerechaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonDerechaActionPerformed
        ...
        if (Pclave.equals("") && categoriaSeleccionada.equals("Categorias")) {
            ...
            if (contador < (videosGuardados.size() - 1)) {
                ...
                //******************************************************************
                contadorVideo = 1 + contadorVideo;
                Contador.setText(String.valueOf(contadorVideo));

                //******************************************************************
                //Método que actualiza los comentarios del video cada vez que se haga un cambio
                //de búsqueda
            ...
            if (contador < (videosPalabraBuscar.size() - 1)) {

                contador = 1 + contador;
                MostrarVideosPalabraBusquedad();
                BotonIzquierda.setEnabled(true);
            ...
            if (contador < (videosCategoriasBuscar.size() - 1)) {

                contador = 1 + contador;
                MostrarVideosCategoriaSeleccionada();
    ...
    private void RegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegresarActionPerformed
        ...
        GUIprincipal5.setNombreUsuarioPrincipal(nombreUsuarioBusquedadV);
        GUIprincipal5.show();
        this.dispose();
    ...
    private void BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarActionPerformed
        ...
        if (Pclave.equals("") && categoriaSeleccionada.equals("Categorias")) {
            ...
            if (!"".equals(Pclave)) {
                ...
                if (videosPalabraBuscar.isEmpty() == false) {

                    videosPalabraBuscar.clear();
                ...
                if (videosPalabraBuscar.isEmpty() == false) {
                    ...
                    jLabelContador.setText("/" + String.valueOf(videosPalabraBuscar.size()));
                    BotonIzquierda.setEnabled(false);
                    Contador.setText(String.valueOf(contadorVideo));
                ...
                if (videosCategoriasBuscar.isEmpty() == false) {

                    videosCategoriasBuscar.clear();

                }//Fin if

                VideosCategoriaBusquedad();
                ...
                if (videosCategoriasBuscar.isEmpty() == false) {
                    ...
                    jLabelContador.setText("/" + String.valueOf(videosCategoriasBuscar.size()));
                    BotonIzquierda.setEnabled(false);
                    Contador.setText(String.valueOf(contadorVideo));
                    mostrar.setEnabled(true);
    ...
    private void DerechaComentarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DerechaComentarioActionPerformed
        ...
        if (contadorComentario < (comentariosVideos.size() - 1)) {
    ...
    private void guardarCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarCActionPerformed
        ...
        if (Respuesta == 0) {
            ...
            ControlComentarioVideo cCVideo = new ControlComentarioVideo();
            ...
            boolean t = cCVideo.ModificarComentario(comentariosVideos.get(contadorComentario).getIdComentario(), Cvideo);
    ...
    private void eliminarCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarCActionPerformed
        ...
        if (Respuesta == 0) {
            ...
            ControlComentarioVideo cCimagen = new ControlComentarioVideo();

            boolean t = cCimagen.EliminarComentario(comentariosVideos.get(contadorComentario).getIdComentario(), nombreUsuarioBusquedadV);
            ...
            if (t) {
                ...
                comentariosVideos.remove(contadorComentario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusquedaVideos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusquedaVideos().setVisible(true);
            }
        });
    }
    ...
    public void TraerVideos() {
        ...
        videosGuardados = CI.BuscarVideosGuardados();

    }//Fin método

    public void MostrarVideos() {

        FormatoV.setText(videosGuardados.get(contador).getFormato_Video());
        NombreV.setText(videosGuardados.get(contador).getNombreVideo());

        String duracion = videosGuardados.get(contador).getDuracionVideo();
        ...
        CategoriaV.setText(videosGuardados.get(contador).getCategoriaVideo());
        DescripcionV.setText(videosGuardados.get(contador).getDescripcionVideo());
        FechaSubida.setText(videosGuardados.get(contador).getFechaSubidaV());

        jLabelNombreU.setText(videosGuardados.get(contador).getNombreUsuarioV());

        //Se pasa la imagen que está en un arreglo de byte para convertirlo en un icono
        ImageIcon icon = new ImageIcon(BusquedaVideos.class.getResource("/Imagenes/video-icon.jpg"));
        ImageIcon icon2 = new ImageIcon(videosGuardados.get(contador).getImagenUsuario());
        ...
        Icon icono = new ImageIcon(icon.getImage().getScaledInstance(jLabelVideo.getWidth(), jLabelVideo.getHeight(), Image.SCALE_DEFAULT));
        ...
        jLabelVideo.setIcon(icono);
        jLabelFoto.setIcon(icono2);

    }//Fin método

    public void MostrarVideosPalabraBusquedad() {

        FormatoV.setText(videosPalabraBuscar.get(contador).getFormato_Video());
        NombreV.setText(videosPalabraBuscar.get(contador).getNombreVideo());
        ...
        CategoriaV.setText(videosPalabraBuscar.get(contador).getCategoriaVideo());
        DescripcionV.setText(videosPalabraBuscar.get(contador).getDescripcionVideo());
        FechaSubida.setText(videosPalabraBuscar.get(contador).getFechaSubidaV());

        jLabelNombreU.setText(videosPalabraBuscar.get(contador).getNombreUsuarioV());

        //Se pasa la imagen que está en un arreglo de byte para convertirlo en un icono
        ImageIcon icon = new ImageIcon(BusquedaVideos.class.getResource("/Imagenes/video-icon.jpg"));
        ImageIcon icon2 = new ImageIcon(videosPalabraBuscar.get(contador).getImagenUsuario());
    ...
    public void MostrarVideosCategoriaSeleccionada() {

        FormatoV.setText(videosCategoriasBuscar.get(contador).getFormato_Video());
        NombreV.setText(videosCategoriasBuscar.get(contador).getNombreVideo());
        ...
        CategoriaV.setText(videosCategoriasBuscar.get(contador).getCategoriaVideo());
        DescripcionV.setText(videosCategoriasBuscar.get(contador).getDescripcionVideo());
        FechaSubida.setText(videosCategoriasBuscar.get(contador).getFechaSubidaV());

        jLabelNombreU.setText(videosCategoriasBuscar.get(contador).getNombreUsuarioV());

        //Se pasa la imagen que está en un arreglo de byte para convertirlo en un icono
        ImageIcon icon = new ImageIcon(BusquedaVideos.class.getResource("/Imagenes/video-icon.jpg"));
        ImageIcon icon2 = new ImageIcon(videosCategoriasBuscar.get(contador).getImagenUsuario());
    ...
    public void VideosPalabraclave() {

        for (int i = 0; i < videosGuardados.size(); i++) {

            if (videosGuardados.get(i).getDescripcionVideo().contains(Pclave)) {

                videosPalabraBuscar.add(videosGuardados.get(i));

            }

        }//Fin for

        if (videosPalabraBuscar.isEmpty()) {
    ...
    public void VideosCategoriaBusquedad() {

        for (int i = 0; i < videosGuardados.size(); i++) {

            if (videosGuardados.get(i).getCategoriaVideo().equals(categoriaSeleccionada)) {

                videosCategoriasBuscar.add(videosGuardados.get(i));

            }//Fin if

        }//Fin for

        if (videosCategoriasBuscar.isEmpty()) {
    ...
    public void TraerCategorias() {
        ...
        categoriasVideos = CC2.LeerCategorias();
    ...
    public void TraerCuenta() {
        ...
        cUsuario = Ccuenta.LeerCuenta(nombreUsuarioBusquedadV);
    ...
    public void CrearEspaciosComentarios() {
        ...
        TextComentario.setText(comentariosVideos.get(contadorComentario).getDescripcionComentario());
        fPublicacion.setText(comentariosVideos.get(contadorComentario).getFechaPublicacion());
        NUsuario.setText(comentariosVideos.get(contadorComentario).getNombreUsuarioComentario());

        ImageIcon icon2 = new ImageIcon(comentariosVideos.get(contadorComentario).getFotoUsuarioComentario());
    ...
    public void ActualizarComentariosGUIPalabraClave() {
        ...
        if (comentariosVideos.isEmpty() == false) {
            ...
            traerComentarios(videosPalabraBuscar.get(contador).getIdContenidoV());
    ...
    public void ActualizarComentariosGUICategoriaBusqueda() {
        ...
        if (comentariosVideos.isEmpty() == false) {
            ...
            //Se vuelve a llamar para traer los comentarios del video actual
            traerComentarios(videosCategoriasBuscar.get(contador).getIdContenidoV());
    ...
    public void ValidarBotonesComentario() {
        ...
        String nombreU = comentariosVideos.get(contadorComentario).getNombreUsuarioComentario();

        if (nombreU.equals(nombreUsuarioBusquedadV)) {
    ...
    public boolean DescargaVideoRuta(File archivo, byte[] video) {
    ...
    public void Descarga(byte[] videos, String NombreVideo, String Formato) {
        ...
        if (respuesta) {
            ...
            JOptionPane.showMessageDialog(null, "Video descargado exitosamente.");
    ...
    private javax.swing.JTextField FormatoV;
