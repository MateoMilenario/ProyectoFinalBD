...
public class ComentarioAudio {
    ...
    public ComentarioAudio() {
    }

    public ComentarioAudio(String FechaPublicacion, String DescripcionComentario) {
        this.FechaPublicacion = FechaPublicacion;
        this.DescripcionComentario = DescripcionComentario;
    }

    public ComentarioAudio(String FechaPublicacion, String DescripcionComentario, String IdComentario, String idContenido, String NombreUsuarioComentario, byte[] FotoUsuarioComentario) {
        this.FechaPublicacion = FechaPublicacion;
        this.DescripcionComentario = DescripcionComentario;
    ...
    public ResultSet ConsultarComentariosAudios(String TraerSQL) {
